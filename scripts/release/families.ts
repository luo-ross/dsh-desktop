...
/** Release packages and the two upstream applications: one shared version across the whole family. */
class DshFamily extends ReleaseFamily {
  readonly id = 'dsh'
  readonly patterns = ['packages/!(experimental)/*/package.json', 'apps/{cli,web}/package.json'] as const
