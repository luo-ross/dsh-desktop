...
export type WorkspaceBrowserInjected = {
  ...
  /**
   * Open a Host Workspace directory in the OS file manager. Present only when
   * the desktop shell exposes the reveal bridge (absent in plain web browsers);
   * rows hide the context-menu entry while this is undefined.
   */
  openLocation?: ((cwd: string) => void) | undefined
}
