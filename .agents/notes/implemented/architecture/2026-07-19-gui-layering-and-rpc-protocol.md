...
The shipped Electron wrapper uses the existing loopback Web carrier; [the desktop packaging note](../feature/2026-08-13-electron-desktop-wrapper.md) supersedes only this note's earlier reservation of IPC as Electron's initial carrier. The protocol still permits a later IPC carrier.
